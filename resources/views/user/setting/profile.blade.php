            ...
            <form action="{{ route('users.update', [Auth::user()->slug, ]) }}" method="POST" role="form" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                        ...
                        <div class="form-group">
                            <div class="input-group flat-input-con">
                                <span class="input-group-addon input-label" style="width: 90px;">Time zone</span>
                                <select class="form-control flat-ui-select" name="timezone" id="timezone" style="box-shadow: none; outline: none; border: 1px solid #F0F0F1; border-left: 0px;">
