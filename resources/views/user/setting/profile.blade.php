                ...
                <div class="tab-content tab-bordered">
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <h2 class="mt0">Profile Picture</h2>
                            <p class="text-muted">Anyone can see your profile picture.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                    <div>
                                        @if(empty(Auth::user()->profile_image))
                                            <img src="{!! new Avatar(Auth::user()->first_name .' '. Auth::user()->last_name, 'square', 194) !!}" class="media-object img-rounded" alt="">
                                        @else 
                                ...
                                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                    <form action="#" enctype='multipart/form-data' id="avatar-upload-form">
                                        <h6 class="mt0">Upload new picture</h6>
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <h2 class="mt0">Personal Information</h2>
                            <p class="text-muted">Other people in your organziation will identify you with these information.</p>
                        </div>
                        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
