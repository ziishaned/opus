                        ...
                        <div class="row">
                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" id="full_name" class="form-control dim-input" value="{{ Auth::user()->full_name }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="bio" id="bio" class="form-control dim-input" rows="3">{{ Auth::user()->bio }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="url">URL</label>
                                    <input type="text" name="url" class="form-control dim-input" value="{{ Auth::user()->url }}">
                                </div>
                                <div class="form-group">
                                    <label for="company">Company</label>
                                    <input type="text" name="company" class="form-control dim-input" value="{{ Auth::user()->company }}">
                                </div>
                                <div class="form-group">
                                    <label for="location">Location</label>
                                    <input type="text" name="location" class="form-control dim-input" value="{{ Auth::user()->location }}">
                                </div>
                                <div class="form-group">
