                ...
                <div class="media-body">
                    <div class="event-top">
                        ...
                        <div class="pull-left">
                            ...
                            @if($activity->name == 'updated_page')
                                You updated page <a href="{{ route('pages.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug, $activity->subject->slug]) }}" style="color: #337ab7;">{{ $activity->subject['name'] }}</a> at wiki <a href="" style="color: #337ab7;">{{ $activity->subject->wiki->name }}</a> at wiki <a href="{{ route('wikis.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug]) }}" style="color: #337ab7;">{{ $activity->subject->wiki->name }}</a>.
                            @endif
                            ...
                            @if($activity->name == 'created_comment')
                                ...
                                @else
                                    You commented on page <a href="{{ route('pages.show', [$team->slug, $activity->subject->page->wiki->category->slug, $activity->subject->page->wiki->slug, $activity->subject->page->slug]) }}" style="color: #337ab7;">{{ $activity->subject->page->name }}</a> at wiki <a href="" style="color: #337ab7;">{{ $activity->subject->page->wiki->name }}</a>.
                                @endif
                            @endif

                            @if($activity->name == 'deleted_comment')
                                @if($activity->subject->subject_type === 'App\Models\Wiki')
                                    You deleted comment from wiki <a href="{{ route('wikis.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug]) }}" style="color: #337ab7;">{{ $activity->subject->wiki->name }}</a> at wiki .
                                @else
                                    You deleted comment from page <a href="{{ route('pages.show', [$team->slug, $activity->subject->page->wiki->category->slug, $activity->subject->page->wiki->slug, $activity->subject->page->slug]) }}" style="color: #337ab7;">{{ $activity->subject->page->name }}</a> at wiki <a href="" style="color: #337ab7;">{{ $activity->subject->page->wiki->name }}</a>.
                                @endif
                            @endif
                            ...
                            @if($activity->name == 'updated_comment')
                                ...
                                @else
                                    You updated comment on page <a href="" style="color: #337ab7;">{{ $activity->subject->page->name }}</a> at wiki <a href="{{ route('pages.show', [$team->slug, $activity->subject->page->wiki->category->slug, $activity->subject->page->wiki->slug, $activity->subject->page->slug]) }}" style="color: #337ab7;">{{ $activity->subject->page->wiki->name }}</a>.
                                @endif
                            @endif
                        </div>
