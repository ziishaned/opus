				...
				<div class="media-body">
					<div class="event-top">
						...
						<div class="pull-left">
                            ...
                            @if($activity->name == 'updated_page')
                                <a href="{{ route('users.show', [$team->slug, $activity->user->slug]) }}" style="color: #337ab7;">{{ $activity->user->first_name .' '. $activity->user->last_name }}</a> updated page <a href="{{ route('pages.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug, $activity->subject->slug]) }}" style="color: #337ab7;">{{ $activity->subject['name'] }}</a> at wiki <a href="{{ route('wikis.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug]) }}" style="color: #337ab7;">{{ $activity->subject->wiki->name }}</a> at wiki <a href="{{ route('wikis.show', [$team->slug, $activity->subject->wiki->category->slug, $activity->subject->wiki->slug]) }}" style="color: #337ab7;">{{ $activity->subject->wiki->name }}</a>.
                            @endif
